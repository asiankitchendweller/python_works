...
if score < 50:
	...
	print(f"Astounding! A++ for a change! Your friends are going to envy you, and your existence is in danger if you're from some extreme states of the world. Worry not! You're already this smart to finish this code so you'd have to know how to hide yourself from CIA agents. 👮‍♂️👮‍♂️")